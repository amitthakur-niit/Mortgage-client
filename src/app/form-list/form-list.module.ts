...
@NgModule({
  declarations: [ContentComponent, HowToApplyComponent, ValuationComponent, MortgageOptionsComponent, ConfirmMortgageComponent, PropertyDetailsComponent, PaymentDetailsComponent, HeaderComponent,ReviewAndSubmitComponent],
  imports: [
    CommonModule,
